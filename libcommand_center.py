...
# Socket Constants
UNIX_SOCKET_PATH = "/tmp/DVRCommandCenterSocket"
SERVER_TIMEOUT = 5
CLIENT_TIMEOUT = 5
...
# TODO Push these into an /etc config file
# Recording Path Contstants
RECORD_MPEG_FOLDER = "/mnt/raid/Recordings/.mpeg/"

# Transcoding Path Contstants
TRANSCODE_OUT_FOLDER = "/mnt/raid/Recordings/"
